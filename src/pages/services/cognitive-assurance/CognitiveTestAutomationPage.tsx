...
import { CheckCircle2, Brain, Sparkles, ArrowRight } from 'lucide-react';
import { PageContainer } from '../../../components/PageContainer';
import { useTheme } from '../../../contexts/ThemeContext';
import { ServicePill } from '../../../components/ServicePill';

export function CognitiveTestAutomationPage() {
  const { theme } = useTheme();

  const relatedServices = [
    { icon: Sparkles, title: 'Production Monitoring', description: 'Intelligent monitoring, detection, and insights', gradient: 'from-pink-500 to-purple-600', link: '/services/cognitive-assurance/ai-production-monitoring' },
    { icon: CheckCircle2, title: 'Cognitive Performance Testing', description: 'AI-powered detection of performance risks', gradient: 'from-purple-500 to-pink-500', link: '/services/cognitive-assurance/cognitive-performance-testing' }
  ];

  const capabilities = ['Self-healing automation with ML-driven adaptation', 'AI-powered case generation and optimization', 'Visual regression testing using computer vision', 'Predictive test selection based on risk', 'Intelligent maintenance with zero script rework', 'Natural language–driven test creation'];
  const processSteps = [
    { title: 'Training', description: ' AI models learn structure, behavior, and patterns' },
    { title: 'Generation', description: ' Automated creation of test cases' },
    { title: 'Execution', description: ' Run intelligent and optimized test suites' },
    { title: 'Adaptation', description: ' Self-healing mechanisms repair broken tests' },
    { title: 'Optimization', description: ' ML-driven insights refines effectiveness' }
  ];
  const tools = ['Testim', 'Mabl', 'Applitools', 'Functionize', 'Test.ai', 'Sauce Labs'];
  const metrics = [
    { value: '90%', label: ' Test maintenance eliminated', sublabel: '' },
    { value: '5x', label: ' Faster test creation', sublabel: '' },
    { value: '99%', label: ' Automation accuracy', sublabel: '' }
  ];
  ...
  return (
    <PageContainer>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl mb-6" style={{ color: 'var(--text-primary)' }}>Test Automation <span className="text-2xl lg:text-3xl">(AI-assisted test generation/maintenance)</span></h1>
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>Transform test automation with AI-assisted test generation and intelligent maintenance. Cogniron's Cognitive Test Automation reduces test maintenance by 90% and accelerates test creation 5x faster using self-healing models and ML-powered validation.</p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>Achieve 99% accuracy with intelligent test generation that learns your application behavior, adapts to change, and continuously optimizes test coverage without manual rework.</p>
            ...
            <div className="relative">
              ...
              <div className="relative backdrop-blur-sm rounded-3xl p-8" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-md)' }}>
                ...
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Self-Healing AI Automation</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>Machine learning models automatically generate, maintain, and optimize test suites. As your application evolves, AI adapts to keep the tests resilient, accurate, and execution-ready.</p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-lg p-4" style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.5)' : 'rgba(241, 245, 249, 1)' }}><div className="text-3xl bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">90%</div><div className="text-sm" style={{ color: 'var(--text-secondary)' }}> Reduction in test maintenance</div></div>
                  <div className="rounded-lg p-4" style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.5)' : 'rgba(241, 245, 249, 1)' }}><div className="text-3xl bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">5x</div><div className="text-sm" style={{ color: 'var(--text-secondary)' }}> Faster test creation</div></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-4xl md:text-5xl mb-12" style={{ color: 'var(--text-primary)' }}><span className="gradient-text">Our Cognitive Automation Lifecycle</span></h2>
          <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="backdrop-blur-sm rounded-2xl p-8" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-sm)' }}>
            ...
            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Custom-trained AI/ML models tailored to your application architecture
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="backdrop-blur-sm rounded-2xl overflow-hidden transition-all" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-md)' }}>
            ...
            <div className="p-8">
              <span className="inline-block px-4 py-2 text-sm rounded-lg mb-4" style={{ background: theme === 'dark' ? 'linear-gradient(135deg, rgba(236, 72, 153, 0.2), rgba(147, 51, 234, 0.2))' : 'linear-gradient(135deg, rgba(236, 72, 153, 0.1), rgba(147, 51, 234, 0.1))', color: '#EC4899', border: `1px solid ${theme === 'dark' ? 'rgba(236, 72, 153, 0.3)' : 'rgba(236, 72, 153, 0.2)'}` }}>SaaS Platform</span>
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>90% Reduction in Test Maintenance with Cognitive Automation</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>A high-growth SaaS provider replaced brittle scripts with AI-driven automation, dramatically reducing maintenance overhead while improving accuracy and release velocity.</p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Move Beyond Scripted Automation</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Adopt cognitive test automation that learns, adapts, and improves with every release.</p>
