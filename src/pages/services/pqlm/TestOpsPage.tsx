...
import { CheckCircle2, Workflow, Gauge, Zap, ArrowRight } from 'lucide-react';
...
export function TestOpsPage() {
  ...
  const relatedServices = [
    {
      ...
      description: 'Instant build validation before deeper testing begins',
    ...
    },
    {
      ...
      description: 'Consistent quality standards enforced across pipelines',
    ...
    },
    {
      ...
      description: 'Automated validation of business-critical flows',
  ...
  const capabilities = [
    'Intelligent test orchestration and scheduling',
  ...
  const processSteps = [
    { title: 'Assessment', description: 'Evaluate current testing workflows, tools, and bottlenecks' },
    { title: 'Design', description: 'Define a scalable TestOps architecture aligned to pipelines' },
    { title: 'Implementation', description: 'Automate execution, environments, and reporting' },
    { title: 'Integration', description: 'Embed TestOps into CI/CD workflows' },
    { title: 'Optimization', description: 'Continuously refine execution speed and coverage' }
  ];

  const tools = ['Jenkins', 'GitLab CI', 'CircleCI', 'Selenium Grid', 'Kubernetes', 'Docker'];

  const metrics = [
    { value: '85%', label: 'Automation coverage achieved', sublabel: '' },
    { value: '70%', label: 'Reduction in execution cycles', sublabel: '' },
    { value: '100%', label: 'CI/CD pipeline integration', sublabel: '' }
  ];
    ...
    <PageContainer>
      <section className="relative pt-32 pb-20 overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            <Link to="/services/pqlm" className="text-teal-500 hover:text-teal-600 transition-colors inline-flex items-center gap-2">
              ← Back to PQLM
            </Link>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${theme === 'dark' ? 'rgba(20, 184, 166, 0.3)' : 'rgba(20, 184, 166, 0.2)'}`,
                }}
              >
                <span className="text-teal-500 text-sm">PQLM Service</span>
              </div>
              ...
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Modernize and automate your testing operations with TestOps designed to orchestrate execution, optimize environments, and embed testing seamlessly into your CI/CD pipelines. TestOps turns fragmented test activities into a continuous, intelligent quality pipeline.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                Organizations achieve 85%+ automation coverage and 70% faster execution cycles, enabling testing to keep pace with rapid delivery without sacrificing reliability.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                <Workflow className="w-16 h-16 text-teal-500 mb-4" />
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Intelligent Test Orchestration</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Coordinate test execution, environments, and data with precision, scale, and speed.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Automation coverage</div>
                  </div>
                  <div
                    className="rounded-lg p-4"
                    style={{
                  ...
                  >
                    ...
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Faster execution</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {relatedServices.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl mb-3 group-hover:text-teal-500 transition-colors" style={{ color: 'var(--text-primary)' }}>{service.title}</h3>
      ...
      <section className="relative py-20" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-4xl md:text-5xl mb-12" style={{ color: 'var(--text-primary)' }}><span className="gradient-text">Our TestOps Delivery Model</span></h2>
          <div className="relative">
            <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Additional tools aligned to your delivery ecosystem
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>From Manual Bottlenecks to Pipeline-Driven Testing</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                A fast-growing fintech organization transformed its testing operations by adopting a TestOps-led execution model.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Ready to Operationalize Quality?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Accelerate delivery with pipeline-first testing orchestration designed for scale.</p>
