...
import { CheckCircle2, GitBranch, CheckCircle, Settings, Target, ArrowRight } from 'lucide-react';
import { PageContainer } from '../../../components/PageContainer';
import { useTheme } from '../../../contexts/ThemeContext';

export function IntegrationTestingPage() {
  ...
  const relatedServices = [
    {
      ...
      description: 'Ensure business logic functions correctly before integration',
    ...
    },
    {
      ...
      description: 'Validate consistent behavior across environments and platforms',
    ...
    },
    {
      ...
      description: 'Confirm integration stability at every build',
  ...
  const capabilities = [
    'API and service-level integration testing',
    'Microservices communication validation',
    'Third-party system integrations',
    'Database and data consistency validation',
    'Message queue and event stream testing',
    'End-to-end workflow validation'
  ];

  const processSteps = [
    { title: 'Integration Mapping', description: 'Identify services, dependencies, and failure points' },
    { title: 'Strategy Definition', description: 'Define scope, test layers, and validation criteria' },
    { title: 'Test Development', description: 'Create reusable, automated integration test suites' },
    { title: 'Execution & Validation', description: 'Run tests across environments and stages' },
    { title: 'Continuous Monitoring', description: 'Track integration health through CI/CD pipelines' }
  ];

  const tools = ['Postman', 'REST Assured', 'SoapUI', 'Karate', 'JMeter', 'Docker'];

  const metrics = [
    { value: '95%', label: 'Integration coverage across all endpoints', sublabel: '' },
    { value: '80%', label: 'Integration defects detected pre-production', sublabel: '' },
    { value: '3×', label: 'Faster identification of integration failures', sublabel: '' }
  ];
  ...
  return (
    <PageContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Ensure reliable communication across microservices, APIs, databases, and third-party platforms. Our integration testing validates data integrity, service interactions, and workflow continuity, so that systems work together exactly as intended.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                From API contracts to complex distributed architectures, we help identify up to 80% of integration defects before production while achieving 95% integration coverage.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                <GitBranch className="w-16 h-16 text-pink-500 mb-4" />
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Seamless System Connectivity</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Validate every integration point, service dependency, and data exchange to prevent downstream failures.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Integration coverage</div>
                  </div>
                  <div
                    className="rounded-lg p-4"
                    style={{
                  ...
                  >
                    <div className="text-3xl gradient-text">3×</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Faster defect detection</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-4xl md:text-5xl mb-12" style={{ color: 'var(--text-primary)' }}><span className="gradient-text">Our Integration Testing Approach</span></h2>
          <div className="relative">
            <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Additional tools selected based on architecture and integration complexity
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Scaling 150+ API Integrations Without Downtime</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                A rapidly scaling SaaS provider implemented automated integration testing to support frequent releases while maintaining system stability and uptime.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Ready to Eliminate Integration Risk?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Ensure every system, service, and API works together seamlessly before issues impact users.</p>
