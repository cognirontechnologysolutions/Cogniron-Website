...
import { CheckCircle2, Users, Heart, Target, ArrowRight } from 'lucide-react';
import { PageContainer } from '../../../components/PageContainer';
import { useTheme } from '../../../contexts/ThemeContext';

export function UXUserAcceptanceTestingPage() {
  ...
  const relatedServices = [
    {
      icon: Heart,
      title: 'A/B Testing',
      description: 'Data-backed UX decision validation',
    ...
    },
    {
      ...
      description: 'Pre-launch UX completeness',
    ...
    },
    {
      ...
      description: 'Inclusive and compliant user experiences',
  ...
  const capabilities = [
    'End-to-end user journey and validation',
    'Moderated and unmoderated usability testing',
    'Task completion and success analysis',
    'User satisfaction and NPS measurement',
    'Emotional response and friction identification',
    'Design system and UX standard validation'
  ];

  const processSteps = [
    { title: 'Planning', description: 'Define UX success criteria' },
    { title: 'Recruitment', description: 'Select representative users' },
    { title: 'Facilitation', description: 'Conduct structured testing sessions' },
    { title: 'Analysis', description: 'Synthesize actionable user insights' },
    { title: 'Recommendation', description: 'Prioritize UX improvements' }
  ];

  const tools = ['UserTesting', 'Maze', 'Lookback', 'UsabilityHub', 'Hotjar', 'FullStory'];

  const metrics = [
    { value: '94%', label: 'User Satisfaction', sublabel: '' },
    { value: '88%', label: 'Task Success', sublabel: '' },
    { value: '-65%', label: 'UX Issues Pre-Launch', sublabel: '' }
  ];
    ...
    <PageContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl mb-6" style={{ color: 'var(--text-primary)' }}>
                User Acceptance Testing <span style={{ fontSize: '0.5em' }}>(User-Centric Validation)</span>
              </h1>
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Validate your UX with real users before launch. Test critical workflows, measure satisfaction, and confirm your experience meets real user expectations through structured UAT.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                Achieve 94% user satisfaction, 88% task success, and uncover 65% fewer UX issues pre-launch with rigorous user acceptance testing.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                ...
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Real User Validation</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Test with real users, not assumptions. Understand authentic behaviors, preferences, and friction points before the launch.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="text-3xl gradient-text">94%</div>
                  ...
                  <div
                    ...
                    style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.5)' : 'rgba(241, 245, 249, 1)' }}
                  >
                    <div className="text-3xl gradient-text">88%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Task Success</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>FinTech Platform</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                Validated UX with real users, achieving 94% satisfaction, 88% task success, and identifying 65% fewer UX issues before the launch.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Want to Gain User Confidence <span className="gradient-text">Before Release</span>?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Validate real user experiences confidently before the launch.</p>
