...
import { CheckCircle2, TestTube, TrendingUp, Target, ArrowRight } from 'lucide-react';
...
export function ABTestingPage() {
  ...
  const relatedServices = [
    {
      ...
      description: 'Inclusive design and WCAG compliance validation',
      gradient: 'from-purple-500 to-pink-500',
      link: '/services/ux-assurance/accessibility-testing'
    },
    {
      icon: CheckCircle2,
      title: 'UX Compatibility Testing',
      description: 'Consistent experience across devices and platforms',
    ...
    },
    {
      ...
      description: 'Real-time UX signals and behavioral insights',
  ...
  const capabilities = [
    ...
    'Statistical significance and confidence validation',
    'User behavior, conversion, and funnel analytics',
    'Experience optimization across key journeys',
    'Heatmaps and session replay analysis',
    'Personalization and audience segmentation testing'
  ];

  const processSteps = [
    { title: 'Hypothesis', description: 'Define objectives, success metrics, and test assumptions' },
    { title: 'Design', description: 'Create experience variations and audience segments' },
    { title: 'Execute', description: 'Deploy experiments with real-time monitoring' },
    { title: 'Analyze', description: 'Validate results using confidence scoring' },
    { title: 'Optimize', description: 'Roll out winning variants and iterate continuously' }
  ];

  const tools = ['Optimizely', 'VWO', 'Google Optimize', 'Adobe Target', 'Mixpanel', 'Hotjar'];

  const metrics = [
    { value: '+32%', label: 'Conversion improvement', sublabel: '' },
    { value: '95%', label: 'Statistical confidence', sublabel: '' },
    { value: '2x', label: 'Revenue impact', sublabel: '' }
  ];
  ...
  return (
    <PageContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Data-driven experimentation to optimize user experience and maximize conversions. We help you test design and experience variations, validate hypotheses, and make confident UX decisions grounded in data.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                Deliver 32% average conversion uplift and 2x revenue impact through scientifically designed A/B testing programs.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                <TestTube className="w-16 h-16 text-purple-500 mb-4" />
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Optimization, Proven by Data</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Replace assumptions with evidence. Every UX decision is backed by real user behavior and measurable outcomes.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="text-3xl gradient-text">+32%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Average conversion lift</div>
                  </div>
                  <div
                    className="rounded-lg p-4"
                    style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.5)' : 'rgba(241, 245, 249, 1)' }}
                  >
                    <div className="text-3xl gradient-text">2x</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Revenue impact</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-4xl md:text-5xl mb-12" style={{ color: 'var(--text-primary)' }}><span className="gradient-text">Our Experimentation Framework</span></h2>
          <div className="relative">
            <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Additional platforms aligned to your experimentation stack
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Driving 32% Conversion Growth Through Experimentation</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                A leading online retailer optimized critical checkout journeys using structured A/B testing, delivering sustained conversion gains and measurable revenue growth.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Ready to Optimize What Matters Most?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Turn experimentation into a growth engine.</p>
