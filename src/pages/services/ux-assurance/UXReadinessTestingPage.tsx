...
import { CheckCircle2, Shield, Rocket, Eye, ArrowRight } from 'lucide-react';
import { PageContainer } from '../../../components/PageContainer';
import { useTheme } from '../../../contexts/ThemeContext';

export function UXReadinessTestingPage() {
  const { theme } = useTheme();

  const relatedServices = [
    {
      icon: CheckCircle2,
      title: 'UX User Acceptance Testing',
      description: 'Validate experiences with real users',
    ...
    },
    {
      ...
      description: 'Ensure consistent UX across devices and platforms',
  ...
  const capabilities = [
    'Pre-launch audits and validation',
    'End-to-end user flow and journey',
    'Visual and interaction consistency checks',
    'Perceived performance and responsiveness validation',
    'Error handling, edge-case, and fallback testing',
    'First-time user and onboarding experience assurance'
  ];

  const processSteps = [
    { title: 'Audit', description: 'Comprehensive UX assessment against criteria' },
    { title: 'Validation', description: 'Test all critical and secondary user journeys' },
    { title: 'Performance', description: 'Evaluate perceived speed and responsiveness' },
    { title: 'Polish', description: 'Validate micro-interactions and visual refinements' },
    { title: 'Sign-Off', description: 'Formal UX launch readiness approval' }
  ];

  const tools = ['Maze', 'UserTesting', 'Hotjar', 'FullStory', 'Amplitude', 'Mixpanel'];

  const metrics = [
    { value: '99%', label: 'UX completeness', sublabel: '' },
    { value: 'Zero', label: 'Critical UX issues', sublabel: '' },
    { value: '92%', label: 'Positive first impressions', sublabel: '' }
  ];
  ...
  return (
    <PageContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl mb-6" style={{ color: 'var(--text-primary)' }}>
                Readiness Testing <span style={{ fontSize: '0.5em' }}>(UX readiness for go-live)</span>
              </h1>
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Comprehensive pre-launch UX validation to ensure your product makes the right first impression. We validate every user flow, interaction, and experience to confirm UX readiness before production release.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                Achieve 99% UX completeness with zero critical launch issues, and deliver 92% positive first impressions through rigorous readiness validation.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                ...
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Launch-Ready Experience</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Every interaction matters at launch. We ensure your UX is polished, intuitive, and ready for real users from the very first click.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>UX completeness</div>
                  </div>
                  <div
                    className="rounded-lg p-4"
                    style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.5)' : 'rgba(241, 245, 249, 1)' }}
                  >
                    ...
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>User satisfaction</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-4xl md:text-5xl mb-12" style={{ color: 'var(--text-primary)' }}><span className="gradient-text">Our UX Readiness Framework</span></h2>
          <div className="relative">
            <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Additional UX analytics and testing platforms as required
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Launching with Zero UX Issues and 92% User Satisfaction</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                A SaaS platform ensured flawless launch readiness through structured UX validation, eliminating critical UX issues and delivering strong first-use experiences.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Ready to Launch Without UX Risk?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Ensure your product is polished, intuitive, and launch-ready.</p>
