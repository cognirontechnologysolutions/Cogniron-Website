...
import { CheckCircle2, Eye, TestTube, Users, ArrowRight } from 'lucide-react';
...
export function AccessibilityTestingPage() {
  ...
  const relatedServices = [
    {
      icon: TestTube,
      title: 'A/B Testing',
      description: 'Optimize experiences through data-driven experimentation',
    ...
    },
    {
      ...
      description: 'Validate user-centric design decisions',
    ...
    },
    {
      ...
      description: 'Ensure UX readiness before launch',
  ...
  const capabilities = [
    ...
    'ARIA roles and semantics verification',
    'Assistive technology compatibility testing'
  ];

  const processSteps = [
    { title: 'Assess', description: 'Conduct comprehensive accessibility audits' },
    { title: 'Test', description: 'Automated and expert-led manual validation' },
    { title: 'Report', description: 'Detailed findings with severity and impact' },
    { title: 'Remediate', description: 'Actionable recommendations for rapid fixes' },
    { title: 'Certify', description: 'Re-testing and compliance validation' }
  ];

  const tools = ['WAVE', 'axe DevTools', 'JAWS', 'NVDA', 'VoiceOver', 'Lighthouse'];

  const metrics = [
    { value: 'AA / AAA', label: 'WCAG compliance', sublabel: '' },
    { value: '+15%', label: 'Expanded reach', sublabel: '' },
    { value: '90%', label: 'Legal risk reduction', sublabel: '' }
  ];
  ...
  return (
    <PageContainer>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl mb-6" style={{ color: 'var(--text-primary)' }}>
                Inclusive Digital Experiences, Built Right
              </h2>
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Ensure your digital products are accessible, usable, and compliant for all users, including people with disabilities. We validate WCAG 2.1 AA/AAA compliance and deliver clear, actionable remediation guidance.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                Expand your audience by 15%, reduce accessibility-related legal risk by 90%, and build inclusive experiences that strengthen trust and brand value.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                <Eye className="w-16 h-16 text-purple-500 mb-4" />
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Accessibility with Impact</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Accessibility goes beyond compliance. It improves usability, reach, and customer confidence.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="text-3xl gradient-text">+15%</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Market reach</div>
                  </div>
                  <div
                    className="rounded-lg p-4"
                    style={{
      ...
      >
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl mb-12" style={{ color: 'var(--text-primary)' }}>Tools & <span className="gradient-text">Technologies</span></h2>
          <div
          ...
          >
            ...
            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Additional tools aligned to your technology stack
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Achieving WCAG AAA Compliance for a Government Portal</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                A state government portal serving over 5 million citizens achieved full WCAG AAA compliance, enabling equitable access while minimizing legal and compliance risk.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Ready to Build Inclusive Digital Experiences?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Make accessibility a competitive advantage and not a checkbox.</p>
