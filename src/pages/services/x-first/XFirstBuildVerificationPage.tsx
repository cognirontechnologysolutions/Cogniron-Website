...
export function XFirstBuildVerificationPage() {
  const { theme } = useTheme();

  const relatedServices = [
    {
      icon: Zap,
      title: 'XFirst TestOps',
      description: 'Pipeline-first orchestration',
  ...
  const capabilities = [
    'Commit-level build smoke testing',
    'Continuous integration validation',
    'Sub-10-minute feedback loops',
    'Automated build quality gates',
    'Parallel verification execution',
    'Build stability metrics and trend analysis'
  ];

  const processSteps = [
    { title: 'Trigger', description: 'Every commit to the main branch' },
    { title: 'Build', description: 'Compile and package artifacts' },
    { title: 'Verify', description: 'Execute critical-path smoke tests' },
    { title: 'Report', description: 'Instant feedback to developers' },
    { title: 'Gate', description: 'Block unstable builds early' }
  ];

  const tools = ['Jenkins', 'GitLab CI', 'CircleCI', 'TeamCity', 'Azure DevOps', 'Travis CI'];

  const metrics = [
    { value: '<10 min', label: 'Feedback Time', sublabel: '' },
    { value: '95%', label: 'Build Stability', sublabel: '' },
    { value: '-80%', label: 'Bad Deployments', sublabel: '' }
  ];
    ...
    <PageContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl mb-6" style={{ color: 'var(--text-primary)' }}>
                Build Verification Testing <span style={{ fontSize: '0.5em' }}>(Early and Frequent Checks)</span>
              </h1>
              <p className="text-xl leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
                Shift-left build quality with continuous verification. Detect critical issues within 10 minutes of every commit using automated smoke tests and enforced quality gates.
              </p>
              <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
                Achieve 95% build stability, cut feedback cycles to under 10 minutes, and reduce bad deployments by 80% through early, automated build validation.
              </p>
              <Link
                to="/contact"
            ...
            <div className="relative">
              ...
              >
                ...
                <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>Lightning-Fast Feedback</h3>
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                  Verify every commit in minutes. Stop build breaks before they slow down teams or reach downstream stages.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="text-3xl gradient-text">&lt;10min</div>
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Feedback</div>
                  </div>
                  <div
                    className="rounded-lg p-4"
                    style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.5)' : 'rgba(241, 245, 249, 1)' }}
                  >
                    ...
                    <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Stability</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl mb-4" style={{ color: 'var(--text-primary)' }}>SaaS Platform</h3>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>
                A SaaS provider achieved 95% build stability and reduced bad deployments by 80% through continuous build verification with sub-10-minute developer feedback.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl mb-6" style={{ color: 'var(--text-primary)' }}>Stop Bad Builds at the <span className="gradient-text">Gate</span></h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>Catch build failures early with continuous, commit-level verification.</p>
